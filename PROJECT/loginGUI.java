...
//             dispose();
//             new TaskManagerGUI(username); // Go to main app GUI
//         } else {
...
//                 ImageIcon bg = new ImageIcon("bg.png"); // Add your image here
...
//         card.setBackground(new Color(0, 0, 0, 150)); // semi-transparent black
